...
import com.myapp.repository.EventLogRepository;
import com.myapp.service.EventLogQueryService;
import com.myapp.service.EventLogService;
import com.myapp.service.criteria.EventLogCriteria;
...
/**
 * REST controller for managing {@link com.myapp.domain.EventLog}.
 */
@RestController
@RequestMapping("/api")
public class EventLogResource {
    ...
    public ResponseEntity<EventLog> updateEventLog(
        ...
        EventLog result = eventLogService.update(eventLog);
        return ResponseEntity
            .ok()
