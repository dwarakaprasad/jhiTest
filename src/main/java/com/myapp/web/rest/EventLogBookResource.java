...
import com.myapp.repository.EventLogBookRepository;
import com.myapp.service.EventLogBookQueryService;
import com.myapp.service.EventLogBookService;
import com.myapp.service.criteria.EventLogBookCriteria;
...
/**
 * REST controller for managing {@link com.myapp.domain.EventLogBook}.
 */
@RestController
@RequestMapping("/api")
public class EventLogBookResource {
    ...
    public ResponseEntity<EventLogBook> updateEventLogBook(
        ...
        EventLogBook result = eventLogBookService.update(eventLogBook);
        return ResponseEntity
            .ok()
