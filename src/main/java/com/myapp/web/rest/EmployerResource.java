...
/**
 * REST controller for managing {@link com.myapp.domain.Employer}.
 */
@RestController
@RequestMapping("/api")
public class EmployerResource {
    ...
    public EmployerResource(EmployerService employerService, EmployerRepository employerRepository) {
    ...
    public ResponseEntity<Employer> updateEmployer(
        ...
        Employer result = employerService.update(employer);
        return ResponseEntity
            .ok()
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/employers/{id}", consumes = { "application/json", "application/merge-patch+json" })
    public ResponseEntity<Employer> partialUpdateEmployer(
        ...
        Optional<Employer> result = employerService.partialUpdate(employer);
