...
public class EventLog implements Serializable {
    ...
    @ManyToOne
    @JsonIgnoreProperties(value = { "user", "eventLogs" }, allowSetters = true)
    ...
    public EventLog createdDate(ZonedDateTime createdDate) {
    ...
    public EventLog updatedDate(ZonedDateTime updatedDate) {
