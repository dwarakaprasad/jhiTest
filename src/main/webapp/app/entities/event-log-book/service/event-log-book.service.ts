...
export class EventLogBookService {
  ...
  protected convertDateFromClient(eventLogBook: IEventLogBook): IEventLogBook {
    return Object.assign({}, eventLogBook, {
      createdDate: eventLogBook.createdDate?.isValid() ? eventLogBook.createdDate.toJSON() : undefined,
      updatedDate: eventLogBook.updatedDate?.isValid() ? eventLogBook.updatedDate.toJSON() : undefined,
    });
  }
