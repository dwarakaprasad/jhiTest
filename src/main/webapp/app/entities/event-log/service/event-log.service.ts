...
export class EventLogService {
  ...
  protected convertDateFromClient(eventLog: IEventLog): IEventLog {
    return Object.assign({}, eventLog, {
      createdDate: eventLog.createdDate?.isValid() ? eventLog.createdDate.toJSON() : undefined,
      updatedDate: eventLog.updatedDate?.isValid() ? eventLog.updatedDate.toJSON() : undefined,
    });
  }
